...
// parent's keyring.
func (c *Client) Move(ctx context.Context, share *Share, link *Link, newParent *Link, newName string) error {
...
func (c *Client) Rename(ctx context.Context, share *Share, link *Link, newName string) error {
	if link.ParentLink() == nil {
