...
func (c *Client) MkDir(ctx context.Context, share *Share, parent *Link, name string) (*Link, error) {
...
func (c *Client) MkDirAll(ctx context.Context, share *Share, root *Link, path string) (*Link, error) {
